...
insert into public.events (id, organizer_id, title, game_type, starts_at, location, capacity) values
  ('11111111-1111-1111-1111-111111110001', '22222222-2222-2222-2222-222222222201',
   'Friday Night Magic — Standard', 'tcg',
   date_trunc('day', now()) + interval '2 days 2 hours',
  ...
  ('11111111-1111-1111-1111-111111110002', '22222222-2222-2222-2222-222222222202',
   ...
   date_trunc('day', now()) + interval '3 days 2 hours',
  ...
  ('11111111-1111-1111-1111-111111110003', '22222222-2222-2222-2222-222222222203',
   ...
   date_trunc('day', now()) + interval '5 days 2 hours',
  ...
  ('11111111-1111-1111-1111-111111110005', '22222222-2222-2222-2222-222222222203',
   ...
   date_trunc('day', now()) + interval '8 days 2 hours',
  ...
  ('11111111-1111-1111-1111-111111110008', '22222222-2222-2222-2222-222222222202',
   ...
   date_trunc('day', now()) + interval '19 days 2 hours',
...
from (values
  ...
  ('11111111-1111-1111-1111-111111110009'::uuid, 3)    -- past event
) as e(event_id, n)

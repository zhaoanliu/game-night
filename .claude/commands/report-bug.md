Report a bug as a GitHub issue. The auto-fix bot (workflow-templates/bug-fix.yml) will pick it up, implement a fix, and auto-merge if low-risk. Does NOT implement anything in the current session.
